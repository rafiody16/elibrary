    ...
    <div class="col-md-8">
        <div class="card bg-white shadow-md rounded-lg overflow-hidden">
            <div class="card-header">
                <h2 class="text-lg ml-8 mt-2 font-semibold text-gray-800">Data Categories</h2>
                <button wire:click.prevent="addCategory"
                    ...
                    <span wire:loading wire:target="addCategory" class="mr-2">
                        ...
                        <tbody>
                            @forelse ($categories as $c)
                                <tr class="border-b hover:bg-gray-100">
                                    <td class="px-6 py-4">{{ $c->name_category }}</td>
                                    <td class="px-6 py-4">{{ $c->description }}</td>
                                    <td class="px-6 py-4 text-center">
                                        <button wire:click="editCategory({{ $c->id_category }})"
                                        ...
                                        <button wire:click="deleteCategory({{ $c->id_category }})" wire:confirm="Are you sure you want to delete this category?"
            ...
            <div class="relative p-5 border w-96 shadow-lg rounded-md bg-white" @click.away="Livewire.emit('closeModal')">
                <div class="text-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">
                        {{ $id_category ? 'Edit Category' : 'Create New Category' }}
                    </h3>
